...
export default function StudentProgressPage() {
  ...
  function filterSubject(subject: Subject | "All") {
    ...
    setFiltered(
      subject === "All"
        ? mastery
        : mastery.filter((m) => m.subject === subject),
    );
  }
      ...
      <AppLayout title="My Progress">
        <div style={s.center}>
          ...
          >
            ...
            <p style={{ color: "#8b1a1a", fontWeight: 700, margin: 0 }}>
              {error}
            </p>
          </div>
        </div>
      ...
      <div style={s.page}>
        ...
        <div style={s.topRow}>
          <div>
            ...
            <p style={s.muted}>
              See how you&apos;re doing across all your skills!
            </p>
          </div>
          <button
            className="sp-back"
        ...
        <div style={s.statGrid}>
          {[
            ...
            <div
              key={c.label}
              className="sp-stat"
              style={{ ...s.statCard, background: c.bg, border: c.border }}
            >
              <span
                style={{
                  fontSize: "1.7rem",
          ...
          <div style={s.barCard}>
            ...
            >
              {mastered > 0 && (
                <div
                  style={{
                    width: `${Math.round((mastered / mastery.length) * 100)}%`,
              ...
              {developing > 0 && (
                <div
                  style={{
                    width: `${Math.round((developing / mastery.length) * 100)}%`,
              ...
              {needsHelp > 0 && (
                <div
                  style={{
                    width: `${Math.round((needsHelp / mastery.length) * 100)}%`,
        ...
        {flagged.length > 0 && (
          <div
            ...
            style={{
              ...
              background: "#fffbf0",
              border: "2px solid rgba(200,130,0,0.30)",
              borderRadius: "18px",
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                {flagged.map((f) => f.skill_name ?? "Unknown").join(" · ")}
              </div>
              <div
                style={{
                  fontSize: "0.78rem",
              ...
              >
                These have regressed 2+ times. Keep going — you&apos;ve got
                this! 💪
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              {mastery.length === 0
                ...
                : `No skills for ${activeSubject} yet.`}
            </p>
            <p
              style={{
                margin: 0,
            ...
            >
              {mastery.length === 0
                ...
                : "Try a quiz in this subject to start tracking!"}
            </p>
          </div>
        ) : (
          <div
            ...
            style={{
              ...
              overflow: "hidden",
              border: "2px solid rgba(26,122,64,0.13)",
              boxShadow: "0 2px 16px rgba(13,61,32,0.06)",
            }}
          >
            <table
              style={{
            ...
            >
              ...
              <tbody>
                {filtered.map((m, i) => {
                  ...
                  const sm = m.subject ? subjectMeta[m.subject] : null;
                  return (
                    <tr
                      key={i}
                      className="sp-tr"
                    ...
                    >
                      ...
                      >
                        <span
                          style={{
                            fontWeight: m.regression_count >= 2 ? 800 : 500,
                            color:
