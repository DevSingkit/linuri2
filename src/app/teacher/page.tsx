          ...
          <div style={s.sectionHeader}>
            ...
            {summaries.length > 0 && (
              <span style={s.countBadge}>
                {summaries.length} class{summaries.length !== 1 ? "es" : ""}
              </span>
            )}
          </div>
                    ...
                    <div style={s.classCardTop}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={s.classCardSub}>
                          {cls.total} student{cls.total !== 1 ? "s" : ""}{" "}
                          tracked
                        </div>
                      </div>
                      <div
                        ...
                        <>
                          {cls.mastered > 0 && (
                            <div
                              style={{
                                ...s.barSeg,
                                width: `${pct(cls.mastered)}%`,
                                background:
                                  "linear-gradient(90deg,#1a7a40,#0d5c28)",
                              }}
                              title={`Mastered: ${cls.mastered}`}
                            />
                          )}
                          {cls.developing > 0 && (
                            <div
                              style={{
                                ...s.barSeg,
                                width: `${pct(cls.developing)}%`,
                                background:
                                  "linear-gradient(90deg,#d4a017,#b07800)",
                              }}
                              title={`Developing: ${cls.developing}`}
                            />
                          )}
                          {cls.needsHelp > 0 && (
                            <div
                              style={{
                                ...s.barSeg,
                                width: `${pct(cls.needsHelp)}%`,
                                background:
                                  "linear-gradient(90deg,#c0392b,#8b1a1a)",
                              }}
                              title={`Needs Help: ${cls.needsHelp}`}
                            />
                          )}
                        </>
                      )}
            ...
            <div className="td-content" style={s.tableWrap}>
              <table style={s.table}>
                ...
                <tbody>
                  {flagged.map((f, i) => {
                    const mm =
                      masteryMeta[f.mastery_level] ?? masteryMeta["Needs Help"];
                    return (
                      <tr
                        key={i}
                        className="td-tr"
