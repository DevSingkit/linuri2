      ...
      <div style={s.page}>
        ...
        {total > 0 && (
          <div style={s.summaryCard}>
            <div style={s.barLabel}>
              ...
              <span style={{ fontSize: '0.78rem', color: '#6b7280' }}>{total} records</span>
            </div>
            <div style={s.bar}>
        ...
        {mastery.length === 0 ? (
          <div style={s.empty}>
            ...
            <p style={{ margin: 0, color: '#6b7280', fontSize: '0.85rem' }}>Students need to complete quizzes first.</p>
          </div>
        ) : filtered.length === 0 ? (
          <div style={s.empty}>
            <span style={{ fontSize: '2.5rem' }}>🔍</span>
                  ...
                  return (
                    <tr key={i} className="rp-tr" style={i % 2 === 0 ? s.trEven : s.trOdd}>
                      ...
                      <td style={{ ...s.td, textAlign: 'center' as const }}>
                        <span style={{ fontWeight: m.regression_count >= 2 ? 700 : 400, color: m.regression_count >= 2 ? '#8b1a1a' : '#6b7280', background: m.regression_count >= 2 ? '#fff0f0' : 'transparent', padding: m.regression_count >= 2 ? '2px 8px' : '0', borderRadius: '5px', fontSize: '0.85rem' }}>
...
const s: Record<string, React.CSSProperties> = {
  ...
  btnPrint:    { display: 'flex', alignItems: 'center', gap: '0.5rem', background: '#0d3d20', color: '#ffd166', border: 'none', borderRadius: '9px', padding: '0.65rem 1.35rem', fontWeight: 700, fontSize: '0.85rem', cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 2px 8px rgba(13,61,32,0.18)', transition: 'background 0.15s, transform 0.15s' },
  ...
  bar:         { height: '30px', borderRadius: '10px', background: '#e5e7eb', display: 'flex', overflow: 'hidden', marginBottom: '0.75rem' },
  barSeg:      { height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.7rem', fontWeight: 700, color: '#fff', minWidth: '32px' },
  ...
  subjectGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '1rem', marginBottom: '1.75rem' },
  ...
  subjectName: { fontWeight: 700, fontSize: '0.95rem', color: '#0d3d20' },
  ...
  fBtn:        { background: '#fff', border: '1.5px solid rgba(26,122,64,0.15)', borderRadius: '8px', padding: '0.4rem 0.85rem', fontSize: '0.82rem', fontWeight: 600, cursor: 'pointer', color: '#6b7280', fontFamily: 'inherit', transition: 'background 0.15s, color 0.15s' },
  fBtnActive:  { background: '#0d3d20', color: '#ffd166', borderColor: '#0d3d20' },
  select:      { border: '1.5px solid rgba(26,122,64,0.2)', borderRadius: '9px', padding: '0.5rem 1rem', fontSize: '0.85rem', fontFamily: 'inherit', outline: 'none', color: '#1a1f16', background: '#fdfaf5', cursor: 'pointer', transition: 'border-color 0.15s' },
  search:      { border: '1.5px solid rgba(26,122,64,0.2)', borderRadius: '9px', padding: '0.5rem 1rem', fontSize: '0.85rem', fontFamily: 'inherit', outline: 'none', minWidth: '220px', color: '#1a1f16', background: '#fdfaf5', transition: 'border-color 0.15s' },
  ...
  spinner:     { width: '40px', height: '40px', border: '4px solid #eaf6ef', borderTop: '4px solid #1a7a40', borderRadius: '50%', animation: 'rp-spin 0.8s linear infinite' },
}