      ...
      try {
        ...
        if (lessonList.length > 0) {
          ...
          lessonList.forEach((l) => {
            l.question_count = countMap[l.id] ?? 0;
          });
        }
  ...
  if (loading)
    return (
      <AppLayout title="Lessons">
        ...
        <div style={s.center}>
          <div style={s.spinner} />
          <p style={s.muted}>Loading lessons…</p>
        </div>
      </AppLayout>
    );
    ...
    <AppLayout title="Lessons">
      ...
      <div style={s.page}>
        ...
        <div style={s.filterRow}>
          {(
            ["All", "English", "Mathematics", "Science"] as SubjectFilter[]
          ).map((f) => {
                  ...
                  return (
                    ...
                    >
                      <td
                        ...
                        onClick={() =>
                          router.push(`/teacher/questions?lesson_id=${l.id}`)
                        }
                      >
                        {l.title}
                      </td>
