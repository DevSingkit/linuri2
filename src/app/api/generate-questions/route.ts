...
function buildPrompt(subject: Subject, skillName: string, lessonText: string): string {
  return `
...
- 5 Basic questions — straightforward recall, direct and easy
- 5 Standard questions — application of concepts, requires some thinking
- 5 Advanced questions — analysis and deeper understanding, challenging
...
- Write a short hint in simple friendly language a 12-year-old can understand (2-3 sentences)
- Start hints with "Think about..." or "Remember that..." or "Look back at the part where..."
