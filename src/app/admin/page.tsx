      ...
      <div className="pg">
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: '2.5rem', fontWeight: 800, color: '#0d3d20', lineHeight: 1 }}>
              {teachers.length}
            </span>
          </div>
          <div
        ...
        <div style={S.section}>
          ...
          <div style={S.tableWrap}>
            <table style={S.table}>
              <thead>
                <tr>
                  {['Teacher Name', 'Email', 'Section', 'Subjects', 'Status', 'Actions'].map((h) => (
                    <th key={h} style={S.th}>
                      {h}
                    </th>
                  ))}
              ...
              <tbody>
                {teachers.length === 0 ? (
                  <tr>
                    <td
                      colSpan={6}
                      style={{ ...S.td, textAlign: 'center', padding: '3rem', color: '#6b7280' }}
                    >
                  ...
                  teachers.map((t, i) => (
                    <tr key={t.id} className="adm-tr" style={i % 2 === 0 ? S.trEven : S.trOdd}>
                      <td style={{ ...S.td, fontWeight: 600 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
                          <div style={{ ...S.av, background: '#fffbf0', color: '#7a5500' }}>
                            {t.name.charAt(0).toUpperCase()}
                          </div>
                          {t.name}
                        </div>
                      </td>
                      <td style={{ ...S.td, color: '#6b7280', fontSize: '0.85rem' }}>{t.email}</td>
...
const S: Record<string, React.CSSProperties> = {
  ...
  table: { width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem', minWidth: '720px' },
  th: {
    textAlign: 'left',
